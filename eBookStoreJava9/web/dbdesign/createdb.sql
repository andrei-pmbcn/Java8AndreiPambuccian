...
insert into EBOOKS.USERS(SSN, NAME, PASSWORD, ROLE)
values('2800910121134', 'admin', 'password', 'admin');
------------------------
...
-----------------------
insert into EBOOKS.EBOOKS(ISBN, DENUMIRE, PRET, ID_TYPE, ID_QUALITY, PAGES, STOCKS, ID_GENRE)
values('978-606-40-0091-0', 'Imi pare rau, sunt asteptata', 20.99, 3, 2, 368, 110, 1);--Agnes Martin Lugand

insert into EBOOKS.EBOOKS(ISBN, DENUMIRE, PRET, ID_TYPE, ID_QUALITY, PAGES, STOCKS, ID_GENRE)
values('978-606-40-0114-6', 'In ape adanci', 23.99, 1, 1, 432, 120, 1);  --Paula Hawkins

insert into EBOOKS.EBOOKS(ISBN, DENUMIRE, PRET, ID_TYPE, ID_QUALITY, PAGES, STOCKS, ID_GENRE)
values('978-606-33-1229-8', 'Dupa ce te-am pierdut', 18.99, 2, 2, 234, 120, 1);  --JojoMoyes

insert into EBOOKS.EBOOKS(ISBN, DENUMIRE, PRET, ID_TYPE, ID_QUALITY, PAGES, STOCKS, ID_GENRE)
values('978-606-33-1228-8', 'Un barbat si o femeie', 19.99, 1, 1, 302, 120, 1);  --JojoMoyes

insert into EBOOKS.EBOOKS(ISBN, DENUMIRE, PRET, ID_TYPE, ID_QUALITY, PAGES, STOCKS, ID_GENRE)
values('978-606-33-1329-8', 'Coroana de foc', 69.99, 3, 2, 654, 130, 1);  --KenFollet

insert into EBOOKS.EBOOKS(ISBN, DENUMIRE, PRET, ID_TYPE, ID_QUALITY, PAGES, STOCKS, ID_GENRE)
values('978-973-46-2698-4', 'Cuvinde incrucisate', 13.99, 2, 1, 219, 130, 2);  --Aurora Liiceanu

insert into EBOOKS.EBOOKS(ISBN, DENUMIRE, PRET, ID_TYPE, ID_QUALITY, PAGES, STOCKS, ID_GENRE)
values('978-973-46-3396-8', 'Supuse sau rebele', 25.96, 3, 1, 256, 130, 2);  --Aurora Liiceanu

insert into EBOOKS.EBOOKS(ISBN, DENUMIRE, PRET, ID_TYPE, ID_QUALITY, PAGES, STOCKS, ID_GENRE)
values('978-973-46-2130-9', 'Patru femei, patru povesti', 24.71, 2, 1, 230, 140, 2);  --Aurora Liiceanu

insert into EBOOKS.EBOOKS(ISBN, DENUMIRE, PRET, ID_TYPE, ID_QUALITY, PAGES, STOCKS, ID_GENRE)
values('978-606-79-3128-0', 'Disparuta in Moscova', 34.90, 2, 1, 464, 140, 2);  --mARGUERITE

insert into EBOOKS.EBOOKS(ISBN, DENUMIRE, PRET, ID_TYPE, ID_QUALITY, PAGES, STOCKS, ID_GENRE)
values('978-606-68-3174-1', 'Dictionar de sinonime', 16.90, 1, 2, 160, 140, 3);  --Marius Dulgheru

insert into EBOOKS.EBOOKS(ISBN, DENUMIRE, PRET, ID_TYPE, ID_QUALITY, PAGES, STOCKS, ID_GENRE)
values('978-606-68-3173-1', 'Dictionar de antonime', 19.90, 1, 1, 210, 150, 3);  --Marius Dulgheru

insert into EBOOKS.EBOOKS(ISBN, DENUMIRE, PRET, ID_TYPE, ID_QUALITY, PAGES, STOCKS, ID_GENRE)
values('978-606-68-3172-1', 'Dictionar de omonime', 14.95, 2, 2, 130, 150, 3);  --Marius Dulgheru

insert into EBOOKS.EBOOKS(ISBN, DENUMIRE, PRET, ID_TYPE, ID_QUALITY, PAGES, STOCKS, ID_GENRE)
values('978-606-68-0393-9', 'Caiet de matematica clasa a IX-a', 25.95, 2, 2, 160, 150, 5);  --cLEOPATRA mIHAILESCU

insert into EBOOKS.EBOOKS(ISBN, DENUMIRE, PRET, ID_TYPE, ID_QUALITY, PAGES, STOCKS, ID_GENRE)
values('978-606-68-0394-9', 'Caiet de matematica clasa a X-a', 24.10, 2, 2, 150, 200, 5);  --Mariana Mogus
-----------------------
...
insert into EBOOKS.ORDERS (ID, ID_ISBN, PRICE, STATUS, PAID)
    values (1, '978-606-40-0091-0', 10, 'delivered', true);

insert into EBOOKS.ORDERS (ID, ID_ISBN, PRICE, STATUS, PAID)
    values (2, '978-606-33-1329-8', 10.5, 'delivered', true);

insert into EBOOKS.ORDERS (ID, ID_ISBN, PRICE, STATUS, PAID)
    values (3, '978-973-46-2698-4', 20, 'delivered', false);
